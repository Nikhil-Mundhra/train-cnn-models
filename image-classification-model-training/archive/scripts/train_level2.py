...
Level 2 Router Training — Stratified 5-Fold Cross-Validation.

Model:       ResNet-50 (IMAGENET1K_V2 weights)
Task:        Router (5 Broad Pathologies)
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Train the Level 2 OCT Router (Broad Pathologies)",
...
def main() -> None:
    ...
    logger.info("")
    logger.info("=" * 60)
    logger.info("  OCT Router — Level 2 Training")
    if args.smoke_test:
